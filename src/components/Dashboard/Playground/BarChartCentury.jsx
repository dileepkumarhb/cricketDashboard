...
import { getCenturiesPerTeamOverYear } from "../extract";
const { BarChart, Bar, XAxis, YAxis, Tooltip } = Recharts;

const BarChartCentury = props => {
  let result = getCenturiesPerTeamOverYear(props.team);
...
export default BarChartCentury;
